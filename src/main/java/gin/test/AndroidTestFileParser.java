...
public class AndroidTestFileParser {
    private static String[] kywords = {"public", "private", "protected", "static", "final", "abstract", "native", "synchronized"};
    ...
    public  static List<AndroidTest> parseFile(File testFile){
        try {
            ...
            System.err.println("File " + testFile.toString() + " not parsable");
            e.printStackTrace();
            System.exit(1);
        }
        return null;
